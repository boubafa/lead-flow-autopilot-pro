      ...
      <div className="container mx-auto">
        ...
        <div className="max-w-6xl mx-auto">
          <div className="flex flex-col lg:flex-row items-center justify-between space-y-8 lg:space-y-0 lg:space-x-4">
            {steps.map((step, index) => <div key={index} className="flex flex-col lg:flex-row items-center">
                ...
                {index < steps.length - 1 && <ArrowRight className="w-8 h-8 text-gray-400 mt-4 lg:mt-0 lg:mx-4 hidden lg:block" />}
              </div>)}
          </div>
